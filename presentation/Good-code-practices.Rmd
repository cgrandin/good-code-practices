...
---
class: center, middle, inverse, bg_matrix
...
---
class: center, middle, inverse, bg_fire
...
- It almost certain nobody else will be able to get the code to work
...
- Or better yet, for complete platform-independance use `file.path()`:
```r
path <- file.path("github", "main", "project") 
```
