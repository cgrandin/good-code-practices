...
- Solution: Never create dotted variable names or function names
--
.pull-left[
...
.pull-right[
```{r plot-dotted-syntax, ref.label="dotted-syntax", echo = FALSE, out.height = 125}
```
]
--
.pull-left[
...
.pull-right[
```{r plot-dotted-syntax-2, ref.label="dotted-syntax-2", echo = FALSE, out.height = 125}
```
]
.pull-left[
```{r class-check-series, echo = TRUE, eval = TRUE}
class(x)
```
]
