...
### Syntax style standards - example of good code

.pull-left-66[.left[
```{r batman, echo = TRUE, size = "tiny", fig.show = "hide"}
...
- Functions have arguments which should be organized.

- Often they look like this (from the [data table package source on GitHub](https://github.com/Rdatatable/data.table/blob/master/R/between.R)):
...
- Instead write arguments each on their own line:
...
- This allows you to easily comment out individual arguments, and it is much easier to read

- You will appreciate this idea when you see multiple lines of comma-separated arguments
