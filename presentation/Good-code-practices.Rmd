...
- In R, any variable you create in your workspace from the command line is **Global**.
...
### Fix promise errors with the ellipsis argument
.pull-left[.left[
```{r fix-promise-error-ellipsis, echo = TRUE, eval = TRUE}
bar <- function(a, b){
  message("Inside bar(), a = ", a, ", b = ", b)
  a + b
}

foo <- function(bar, x, ...){
  message("Inside foo(), x = ", x)
  bar(...)
}
foo(bar = j, a = 3, b = 4, x = 99)
```
]]
